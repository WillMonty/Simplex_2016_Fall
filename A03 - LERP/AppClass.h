...
class Application
{
	...
	std::vector<std::vector<vector3>> orbitStops; //Vector of vectors of the stops each orbit needs to make. First vector decides the orbit, second decides the stop.
